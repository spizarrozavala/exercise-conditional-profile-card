...
function render(variables = {}) {
  ...
  if (variables.name == null) variables.name = "sebastian";
  if (variables.lastname == null) variables.lastname = "Pizarro";
  if (variables.twitter == null) variables.twitter = "no tengo twitter";
  if (variables.github == "alesanchezr") variables.github = "spizarrozavala";
  if (variables.linkedin == null) variables.linkedin = "spizarrozavala";
  if (variables.instagram == null) variables.instagram = "no tengo instagram";
  if (variables.role == null) variables.role = "Maestro Pizzero";
  if (variables.city == null) variables.city = "santiago";
  if (variables.country == null) variables.country = "Chile";
  if (variables.socialMediaPosition == null || variables.socialMediaPosition == "left") variables.socialMediaPosition = "position-left";
